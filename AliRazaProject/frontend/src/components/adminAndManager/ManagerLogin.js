            ...
            <div>
                <div>
                    ...
                    <div className='div05'>
                        ...
                        <div className='div01'>
                            <div><input onClick={() => { setdisplayErr1('none'); setdisplayErr2('none') }} onChange={handleInput} autoComplete='off' name='name' value={name} className='div03' type="text" placeholder='Name' /></div>
